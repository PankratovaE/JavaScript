...
function showMoreText(card) {
    ...
    let descText = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, fuga. Modi amet dolorem sunt aspernatur?';
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterbegin', `<div class ="desc">${descText}</div>`);
